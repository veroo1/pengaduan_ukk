        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/images.jpeg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $_SESSION["nama"];?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="dist/img/images.jpeg" class="img-circle" alt="User Image">
...
if ($_SESSION["level"] == 'admin') {
  ?>
            ...
            <?php } ?>
            <li><a href="index.php?page=data_pengaduan"><i class="glyphicon glyphicon-education"></i> <span>Data pengaduan</span></a></li>
            <li><a href="index.php?page=data_tanggapan"><i class="glyphicon glyphicon-education"></i> <span>Data tanggapan</span></a></li>
          </ul>
      </li>
